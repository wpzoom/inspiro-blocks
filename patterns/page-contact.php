...
/**
 * Title: Contact
 * Slug: inspiro-blocks/page-contact
...
<main class="wp-block-group alignfull site-content" id="header" style="margin-top:0"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_VHI2O3X89E.jpg","id":7398,"dimRatio":40,"overlayColor":"black","focalPoint":{"x":0.57,"y":0.83},"align":"full","style":{"spacing":{"padding":{"top":"0px"}}}} -->
<div class="wp-block-cover alignfull" style="padding-top:0px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-7398" alt="" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_VHI2O3X89E.jpg" style="object-position:57% 83%" data-object-fit="cover" data-object-position="57% 83%"/><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"header-transparent","theme":"inspiro-blocks"} /-->
...
<h1 class="has-white-color has-text-color has-max-48-font-size">Contact Us</h1>
<!-- /wp:heading -->
...
<h2 class="has-max-48-font-size">Ready to start your next project?</h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>map2.png" alt="" class="wp-image-7500"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<h2 class="has-max-48-font-size">Inspiro</h2>
<!-- /wp:heading -->
