...
/**
 * Title: Services
 * Slug: inspiro-blocks/page-services
...
<main class="wp-block-group alignfull site-content" id="header" style="margin-top:0"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_PT8C3EOE19.jpg","id":7396,"dimRatio":40,"overlayColor":"black","isDark":false,"align":"full","style":{"spacing":{"padding":{"top":"0px"}}}} -->
<div class="wp-block-cover alignfull is-light" style="padding-top:0px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-7396" alt="" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_PT8C3EOE19.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"header-transparent","theme":"inspiro-blocks"} /-->
...
<h1 class="has-white-color has-text-color has-max-48-font-size">Services</h1>
<!-- /wp:heading -->
...
<div class="wp-block-group alignfull pattern_multiple_covers" id="services"><!-- wp:spacer {"height":"84px"} -->
...
<h2 class="has-text-align-left has-max-48-font-size">Our Services</h2>
<!-- /wp:heading -->
...
<div class="wp-block-group alignfull" id="cover" style="margin-top:0px;margin-bottom:0px"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_6O7JXC5DC5.jpg","id":7391,"dimRatio":60,"overlayColor":"black","minHeight":549,"minHeightUnit":"px","contentPosition":"center center","align":"full"} -->
<div class="wp-block-cover alignfull" style="min-height:549px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-60 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-7391" alt="" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_6O7JXC5DC5.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"type":"constrained","contentSize":"1200px"}} -->
...
<h2 class="has-max-48-font-size">Let's work together!</h2>
<!-- /wp:heading -->
...
<h2 class="has-primary-color has-text-color"><strong>1.</strong></h2>
<!-- /wp:heading -->
...
<div class="wp-block-column is-style-default" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--lightgrey);border-left-width:1px;padding-top:35px;padding-right:2%;padding-bottom:35px;padding-left:5%"><!-- wp:heading {"textColor":"primary"} -->
<h2 class="has-primary-color has-text-color"><strong>2.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:column {"style":{"spacing":{"padding":{"top":"35px","right":"2%","bottom":"35px","left":"5%"}},"border":{"top":{"width":"0px","style":"none"},"right":{"width":"0px","style":"none"},"bottom":{"width":"0px","style":"none"},"left":{"color":"var:preset|color|lightgrey","width":"1px"}}},"className":"is-style-default"} -->
<div class="wp-block-column is-style-default" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-style:none;border-bottom-width:0px;border-left-color:var(--wp--preset--color--lightgrey);border-left-width:1px;padding-top:35px;padding-right:2%;padding-bottom:35px;padding-left:5%"><!-- wp:heading {"textColor":"primary"} -->
<h2 class="has-primary-color has-text-color"><strong>3.</strong></h2>
<!-- /wp:heading -->
...
<!-- wp:pullquote {"textAlign":"left","style":{"border":{"width":"0px","style":"none"}},"textColor":"foreground"} -->
<figure class="wp-block-pullquote has-text-align-left has-foreground-color has-text-color" style="border-style:none;border-width:0px"><blockquote><p><strong>Eva Lester</strong></p><cite>Senior Supervisors ・ Fables</cite></blockquote></figure>
<!-- /wp:pullquote --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:pullquote {"textAlign":"left","style":{"border":{"width":"0px","style":"none"}},"textColor":"foreground"} -->
<figure class="wp-block-pullquote has-text-align-left has-foreground-color has-text-color" style="border-style:none;border-width:0px"><blockquote><p><strong>James Richardson</strong></p><cite>Environmental Economist</cite></blockquote></figure>
<!-- /wp:pullquote --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
