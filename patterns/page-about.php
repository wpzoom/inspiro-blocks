...
/**
 * Title: About page
 * Slug: inspiro-blocks/page-about
...
<main class="wp-block-group alignfull site-content" id="header" style="margin-top:0"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_6O7JXC5DC5.jpg","id":7391,"dimRatio":40,"overlayColor":"black","focalPoint":{"x":0.72,"y":0.38},"align":"full","style":{"spacing":{"padding":{"top":"0px"}}}} -->
<div class="wp-block-cover alignfull" style="padding-top:0px"><span aria-hidden="true" class="wp-block-cover__background has-black-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-7391" alt="" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>StockSnap_6O7JXC5DC5.jpg" style="object-position:72% 38%" data-object-fit="cover" data-object-position="72% 38%"/><div class="wp-block-cover__inner-container"><!-- wp:template-part {"slug":"header-transparent","theme":"inspiro-blocks"} /-->
...
<h1 class="has-white-color has-text-color has-max-48-font-size">About Us</h1>
<!-- /wp:heading -->
...
<div class="wp-block-column is-vertically-aligned-center" style="padding-left:var(--wp--preset--spacing--80);flex-basis:50%"><!-- wp:paragraph {"textColor":"primary"} -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team4.png" alt="" class="wp-image-7485"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team5.png" alt="" class="wp-image-7487"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team6.png" alt="" class="wp-image-7489"/></figure>
<!-- /wp:image -->
