 ...
 * Slug: inspiro-blocks/general-team-two-columns
 * Categories: inspiro-blocks-general
 * Viewport Width: 1280
 */
?>
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team1.png" alt="" class="wp-image-115"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team2.png" alt="" class="wp-image-117"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team3.png" alt="" class="wp-image-118"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team4.png" alt="" class="wp-image-119"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team5.png" alt="" class="wp-image-120"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>team6.png" alt="" class="wp-image-121"/></figure>
<!-- /wp:image -->
